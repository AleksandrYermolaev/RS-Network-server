export const users = [
  ...
  },
  {
    ...
    password: '12345',
    about:
      'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur gravida, sem non laoreet porta, tellus',
  },
  {
    id: 3,
    name: 'user3',
    ...
    about:
      'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce vitae auctor leo. In vestibulum lectus in mi efficitur, et bibendum augue sodales. Nam non tellus feugiat augue faucibus commodo nec a ante. Vivamus vel vestibulum ex. Pellentesque sed.',
  },
];
...
export const posts = [
  {
    ...
    imageUrl:
      'https://lh6.googleusercontent.com/cJVy4vk4etKXoT0lvKDVTgcctVaez6f4Im2EM2U4SPomoK84iwdwDJQivZWksR9vAt09DYIjmin19y5EQDmUzh18dCUdXeac8Ts0YDUPusTI3uZmZeqjwqwQp2EPd_IVElBziV9bUrIruQuWyg',
    likes: [1, 2, 3],
    comments: [1],
  },
  {
    ...
    date: date2.getTime(),
    description:
      'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque lobortis auctor varius. Fusce cursus mauris.',
    imageUrl: '',
    likes: [],
    comments: [],
  },
  {
    ...
    date: date3.getTime(),
    description:
      'Lorem ipsum dolor sit amet, consectetur adipiscing elit. In nec ipsum ut eros ullamcorper elementum. Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Quisque at euismod tortor, aliquam molestie diam. Quisque fringilla mi metus, sit.',
    imageUrl:
  ...
  },
  {
    ...
    description: '',
    imageUrl:
      'https://www.takefoto.ru/userfiles/image/Dlya%20Statey/Peizaj%20Pravila/aa6334971e251ce7b4b747fc88bbc5ab.jpg',
    likes: [1, 3],
    comments: [7, 8],
  },
];
...
export const comments = [
  ...
  },
  {
    ...
    date: date31.getTime(),
    description:
      'Vivamus at augue consectetur arcu volutpat efficitur in congue elit. Donec nec metus rutrum, cursus ex eget, commodo arcu. Aliquam erat turpis, mollis quis euismod vel.',
  },
  {
    id: 3,
    postId: 3,
    ...
    date: date32.getTime(),
    description:
      'Vivamus condimentum sit amet orci ut interdum. Duis cursus ante ut',
  },
  {
    id: 4,
    postId: 3,
  ...
  },
  {
    ...
    date: date35.getTime(),
    description:
      'Nullam ligula nibh, luctus in condimentum ut, iaculis eget magna. Cras',
  },
  {
    id: 7,
    postId: 5,
